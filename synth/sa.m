...
%
% The data are generated by slicing a digitally painted 
% 3-colour (R,G,B) picture into small patches.

close all;
clear all;

% Save console output to file
diary('synth-output.txt');

% Program parameters
data = 'zigzag_rgb_data_32';
qf = 50;                % quality factor
b = 4;                  % block size bxb pixels
n_chains = 400;         % number of Markov chains
...
save('synth-final.mat', 'finals');

% End-of-chain errors
save('synth-eoc-l2.mat','err_eoc');
save('synth-eoc-ssim.mat','ssim_eoc');

% Window showing algorithm progress and final state
print('synth-plot','-dpng'); % not optimised
